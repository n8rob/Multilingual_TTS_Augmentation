...
lang_voice = {
    ...
    "de-CH": {"voices": ["de-CH-JanNeural", "de-CH-LeniNeural"], "configs": []},
    "de-DE": {"voices": ["de-DE-AmalaNeural", "de-DE-BerndNeural", "de-DE-ChristophNeural" , "de-DE-ElkeNeural", "de-DE-KasperNeural", "de-DE-KatjaNeural"], "configs": []}
}
...
voice_no_f = open("de-cv-msft-voice-number_map.csv", "a+")


directory = "common_voice/" # Folder to save your audio
